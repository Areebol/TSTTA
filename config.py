...
_C.DATA.DOMAIN_SHIFT_TARGET = 'weather'
_C.DATA.N_VAR = 21
_C.DATA.SEQ_LEN = 96
...
_C.TTA.ENABLE = False
_C.TTA.DOMAIN_SHIFT = False # Enable when train on ETTh1 and test on ETTh2
_C.TTA.METHOD = 'TAFAS'
...
_C.TTA.DUAL = CN()
_C.TTA.DUAL.LR = 1e-3
_C.TTA.DUAL.WEIGHT_DECAY = 0.0001
...
_C.TTA.DUAL.QUERY_TYPE = "freq-base-CI"
_C.TTA.DUAL.LAMBDA_ORTHO = 0.01
_C.TTA.DUAL.LAMBDA_KEYS = 1.0
_C.TTA.DUAL.LAMBDA_BASES = 0.0
_C.TTA.DUAL.DIVERSITY_MARGIN = 0.1

# PKA adapter hyperparameters
_C.TTA.PKA = CN()
_C.TTA.PKA.LR = 1e-3
_C.TTA.PKA.WEIGHT_DECAY = 0.0001
_C.TTA.PKA.PAAS = True
_C.TTA.PKA.PERIOD_N = 1
_C.TTA.PKA.BATCH_SIZE = 64
_C.TTA.PKA.STEPS = 1
_C.TTA.PKA.ADJUST_PRED = True
_C.TTA.PKA.CALI_MODULE = True
_C.TTA.PKA.GATING_INIT = 0.01
_C.TTA.PKA.HIDDEN_DIM = 128
_C.TTA.PKA.GCM_VAR_WISE = True
_C.TTA.PKA.PETSA_LOSS_ALPHA = 0.1
_C.TTA.PKA.LOSS_NAME = "PETSA"
_C.TTA.PKA.CALI_NAME = "tafas_GCM"
_C.TTA.PKA.CALI_INPUT_ENABLE = True
_C.TTA.PKA.CALI_OUTPUT_ENABLE = True
_C.TTA.PKA.N_PATTERNS = 32
_C.TTA.PKA.COBA_ONLINE_ENABLED = False
_C.TTA.PKA.COBA_ONLINE_LR = 1e-3
_C.TTA.PKA.PRETRAIN_EPOCHS = 2
_C.TTA.PKA.GCM_FEA_DIM = 16
_C.TTA.PKA.QUERY_TYPE = "time-CI"
_C.TTA.PKA.LAMBDA_ORTHO = 1.0
_C.TTA.PKA.ENERGY_THRESHOLD = 0.2
_C.TTA.PKA.BIAS_MOMENTUM = 0.1
_C.TTA.PKA.MAX_DYNAMIC_CAPACITY = 16
_C.TTA.PKA.TEMPERATURE = 10.0
