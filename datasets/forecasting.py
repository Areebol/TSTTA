...
# dataset classes using ForecastingDataset
...
class Illness(ForecastingDataset):
    def __init__(self, *args, **kwargs):
        super(Illness, self).__init__(*args, **kwargs)
...
class Electricity(ForecastingDataset):
    def __init__(self, *args, **kwargs):
        super(Electricity, self).__init__(*args, **kwargs)
...
class ETTh1(ForecastingDataset):
    def __init__(self, *args, **kwargs):
        super(ETTh1, self).__init__(*args, **kwargs)
...
class ETTh2(ForecastingDataset):
    def __init__(self, *args, **kwargs):
        super(ETTh2, self).__init__(*args, **kwargs)
...
class ETTm1(ForecastingDataset):
    def __init__(self, *args, **kwargs):
        super(ETTm1, self).__init__(*args, **kwargs)
...
class ETTm2(ForecastingDataset):
    def __init__(self, *args, **kwargs):
        super(ETTm2, self).__init__(*args, **kwargs)
