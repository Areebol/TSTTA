...
# # 参与实验的模型
# MODELS=("FreTSPCD" "iTransformerPCD" "OLSPCD" "MICNPCD" "PatchTSTPCD" "DLinearPCD" ) 
MODELS=("PatchTSTPCD")
...
OFFLINE_LRS=(1e-2 3e-2 5e-2 1e-3 3e-4 1e-4)      # 预训练适配阶段的学习率
ONLINE_LRS=(1e-3 3e-3 5e-3 1e-4 3e-4 5e-4 1e-5)       # 在线流式更新阶段的学习率
...
parallel --lb -j ${TOTAL_JOBS} '
    ...
    RESULT_DIR="./results/0329_COBA/455_2_10/${MODEL}/"

    echo "Job slot {%}: NPU=${NPU_ID} | MODEL=${MODEL} | COBA-Online | ${DATASET} -> ${TARGET} | PRED_LEN=${PRED_LEN}"
