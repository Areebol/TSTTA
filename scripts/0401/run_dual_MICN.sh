...
export OFFLINE_LRS=(1e-2 3e-2 5e-2 1e-3 3e-3 3e-4 1e-4)
...
parallel --lb -j ${TOTAL_JOBS} '
    ...
    CHECKPOINT_DIR="./checkpoints/${MODEL}/${DATASET}_${PRED_LEN}_lr_1e-4"
    RESULT_DIR="./results/0401/Dual_InDomain/${DATASET}/${MODEL}/"
    mkdir -p "${RESULT_DIR}"
...
' ::: "${MODELS[@]}" ::: "${DATASETS[@]}" ::: "${PRED_LENS[@]}" ::: "${OFFLINE_LRS[@]}" ::: "${ONLINE_LRS[@]}" ::: "${SEEDS[@]}"