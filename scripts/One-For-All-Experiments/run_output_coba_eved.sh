...
for GCM_N_BASES in 8 16 32 ;do
for BASE_LR in 1e-1 1e-2 1e-3; do
for TRAIN_BATCH_SIZE in 64 512; do
# for TRAIN_BATCH_SIZE in 512; do
# for ONLINE_LR in 1e-1 3e-1 5e-1 1e-2 3e-2  1e-3 5e-3;  do
# for STEPS in 1 10; do
echo "BASE_LR: ${BASE_LR}, PRETRAIN_EPOCHS: ${PRETRAIN_EPOCHS}, GCM_FEA_DIM: ${GCM_FEA_DIM}, GCM_N_BASES: ${GCM_N_BASES},
 TTA_LR: ${TTA_LR}, STEPS: ${STEPS}, TRAIN_BATCH_SIZE ${TRAIN_BATCH_SIZE} ONLINE_LR: ${ONLINE_LR}, ONLINE_TTA: ${ONLINE_TTA}"
