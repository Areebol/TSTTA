...
parallel --lb -j ${TOTAL_JOBS} '
  ...
  echo "Running experiment: ${MODEL} | ${DATASET} -> ${TARGET} | Len: ${PRED_LEN} | OFFLINE_LR: ${OFFLINE_LR} | BASE_NUMS: ${N_BASES} | SEED: ${SEED} | ONLINE_LR: ${ONLINE_LR} | LAMBDA_ORTHO: ${LAMBDA_ORTHO} | NPU_ID: ${NPU_ID}"
